...
namespace NativePayload_EnumSystemLocalesA
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("NativePayload_EnumSystemLocalesA , Published by Damon Mohammadbagher , Mar 2021");
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("NativePayload_EnumSystemLocalesA Callback Functions Technique via (EnumSystemLocalesA) API");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("Bingo: Meterpreter Session via callback functions Technique by \"EnumSystemLocalesA\"  ;)");
